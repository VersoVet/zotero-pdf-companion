...
PdfCompanion = {
    ...
    async recoverPdf(item, silent = false) {
        ...
        if (toast) toast.update("🔍 Searching for PDF...");

        try {
            // Backend cascade search (10 sources):
            // 1. Unpaywall, 2. arXiv, 3. Europe PMC, 4. CORE, 5. CrossRef,
            // 6. Direct Publisher, 7. DOI Redirect, 8. Hindawi, 9. PMC, 10. Sci-Hub
            this.log("[RecoverPdf] Starting PDF recovery cascade...");
            ...
            xhr.onprogress = function() {
                ...
                for (let line of lines) {
                    ...
                    try {
                        ...
                        switch (evType) {
                            case "workflow_start":
                                toast.update("Démarrage du workflow...");
                                break;
